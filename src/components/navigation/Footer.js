    ...
    return(
        ...
        <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <img
                src={'https://raw.githubusercontent.com/lpzcahuillan/img/049d70f686d322aa43b0f0615970e31ddea7d553/SvgjsG1007.svg'}
                width={60}
                height={60}
                className=""/>
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 xl:text-center">&copy; 2023 Lpzc Software Agency Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
