...
const navigation = {
  ...
  social: [
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/lopez.hlc',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
        ...
        <div className="mx-auto  xl:mx-12 xl:pt-48 xl:pb-64 lg:pt-40 lg:pb-48 pt-24 pb-12  ">
          <div>
            <div>
              ...
              Agencia para
                    <span style= {{color:'#f23005'}}>  
                      <Typewriter
                        words={[' Soñadores', ' Creadores', ' Tí!', ' Y para tu mamá']}
                        loop={0}
                        cursor
              ...
              {navigation.social.map((item) => (
                <a key={item.name} href={item.href} className="text-gray-900 hover:text-gray-800">
                  ...
                  <item.icon className="h-20 w-8" aria-hidden="true" />
                </a>
              ))}
              </div>
            </div>
            <div className="absolute inset-x-0 top-[calc(100%-20rem)] -z-10 transform-gpu overflow-hidden bg-white blur-lg lg:top-[calc(100%-45rem)] sm:top-[calc(100%-30rem)]">
              <img src="https://raw.githubusercontent.com/lpzcahuillan/img/main/Group%201.png" className='w-full object-cover'/>
            </div>
          </div>
        </div>
      </div>
